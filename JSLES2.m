function [x1,state] = JSLES2(y,A,inputParam)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                 fBase(indBS) = real(fBase(indBS));
            ...
            if 1
                alphaU   = min(1./abs([gxU,gyU]),[],'all')/4;
                alphatau = abs(10e-9*c0./gtau);
%                 alphatau = min([abs(10e-9 - deltatau),abs(-10e-9 - deltatau)])*c0./gtau;
                alpha = min([alphaU,alphatau,alphaG,0.4]);
            end
