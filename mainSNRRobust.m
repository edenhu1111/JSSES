...
baselineSelect = [1,1,1,1,1]; %Proposed NoSL SV oracle NoAid
%%
tic
parfor nsim = 1:10
...
%           if 1
            ...
            rmsePhaseI(snrIdx) = evaluate_offgrid_performance(final_pos.', ones(1,length(final_pos)), inputParamtemp.locGT.', 5);
            tauEst = bias/c0;
...
xlabel('SNR/dB',Interpreter='tex',FontName='Times New Roman',FontSize=15);
